...
```
[ ] A1.  Create project (dotnet new webapp)
[ ] A2.  Add NuGet packages
[ ] A3.  Create ManufacturingEnums.cs
[ ] A4.  Create Platform models (Tenant, PlatformUser)
[ ] A5.  Create PlatformDbContext.cs
[ ] A6.  Create leaf models (User, Machine, Material, SystemSetting, etc.)
[ ] A7.  Create stage + part models (ProductionStage, Part, PartStageRequirement)
[ ] A8.  Create work order + quote models
[ ] A9.  Create job + execution models (Job, StageExecution, JobNote)
[ ] A10. Create build models (BuildJob, BuildPackage, BuildFileInfo)
[ ] A11. Create tracking + QC models (PartInstance, QCInspection, DelayLog)
[ ] A12. Create maintenance models
[ ] A13. Create TenantDbContext.cs (~35 DbSets)
[ ] A14. Create TenantDbContextFactory.cs
[ ] A15. Create TenantMiddleware.cs
[ ] A16. Create ITenantContext + TenantContext
[ ] A17. Create Program.cs (DI, auth, middleware)
