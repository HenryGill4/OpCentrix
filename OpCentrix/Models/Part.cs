...
{   
    ...
    public class Part
    {
        ...
        // SLS Material Specifications - FIXED: Added [Required] to match database NOT NULL constraints
        [Required]
        [StringLength(100)]
        public string SlsMaterial { get; set; } = "Ti-6Al-4V Grade 5";
        
        [Required] // Database has NOT NULL constraint
        [StringLength(100)]
        ...
        // Build Parameters - FIXED: These are NOT NULL in database
        [Range(0, 2000)]
        ...
        // Build Environment Requirements - FIXED: These are NOT NULL in database
        [Range(0, 500)]
        ...
        // Surface finish requirements - FIXED: Added [Required] to match database
        [Required] // Database has NOT NULL constraint
        [StringLength(100)]
        ...
        // Process information - FIXED: Added [Required] to match database NOT NULL constraints
        [Required] // Database has NOT NULL constraint
        [StringLength(50)]
        ...
        // SLS-specific setup and timing - FIXED: These are NOT NULL in database
        [Range(0, 300)]
        ...
        // Quality requirements for SLS - FIXED: Added [Required] to match database NOT NULL constraints
        [Required] // Database has NOT NULL constraint
        [StringLength(500)]
        ...
        // Historical averages (calculated from completed jobs) - FIXED: These are NOT NULL in database
        ...
        // Process-specific data (stored as JSON for flexibility) - FIXED: Added [Required] to match database NOT NULL constraints
        [Required] // Database has NOT NULL constraint
        [StringLength(2000)]
        ...
        // Build file information - FIXED: Added [Required] to match database NOT NULL constraints
        [Required] // Database has NOT NULL constraint
        [StringLength(255)]
        ...
        #region Audit Trail - FIXED: Added [Required] to match database NOT NULL constraints
        ...
        // Duration estimates - FIXED: Added [Required] to match database NOT NULL constraints
        [Required] // Database has NOT NULL constraint
        [StringLength(50)]
        ...
        // FIXED: AdminOverrideReason allows NULL in database, so no [Required] needed
        [StringLength(500)]
