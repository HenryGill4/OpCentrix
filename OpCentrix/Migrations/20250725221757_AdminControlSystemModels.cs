...
{
    /// <inheritdoc />
    public partial class AdminControlSystemModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "System"),
                    TriggerType = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    TriggerConditions = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false, defaultValue: "{}"),
                    SeverityLevel = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 3),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    EmailRecipients = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    EmailSubject = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false, defaultValue: "OpCentrix Alert: {AlertName}"),
                    EmailTemplate = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    SendSms = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    SmsRecipients = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    SmsTemplate = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    SendBrowserNotification = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    CooldownMinutes = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 15),
                    ...
                    EscalationRules = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false, defaultValue: "{}"),
                    BusinessHoursOnly = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    BusinessHoursStart = table.Column<TimeSpan>(type: "TEXT", nullable: false),
                    BusinessHoursEnd = table.Column<TimeSpan>(type: "TEXT", nullable: false),
                    BusinessDays = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false, defaultValue: "1,2,3,4,5"),
                    MaxAlertsPerDay = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 10),
                    TriggersToday = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
                    LastDailyReset = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "date('now')"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartDescription = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ...
                    SlsMaterial = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    PowderLotNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    LaserPowerWatts = table.Column<double>(type: "REAL", nullable: false),
                    ScanSpeedMmPerSec = table.Column<double>(type: "REAL", nullable: false),
                    LayerThicknessMicrons = table.Column<double>(type: "REAL", nullable: false),
                    EstimatedPowderUsageKg = table.Column<double>(type: "REAL", nullable: false),
                    ActualPowderUsageKg = table.Column<double>(type: "REAL", nullable: false),
                    LaborCostPerHour = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    MaterialCostPerKg = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    MachineOperatingCostPerHour = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    ArgonCostPerHour = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    DensityPercentage = table.Column<double>(type: "REAL", nullable: false),
                    SurfaceRoughnessRa = table.Column<double>(type: "REAL", nullable: false),
                    Operator = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    QualityInspector = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Supervisor = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CustomerOrderNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CustomerDueDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    QualityCheckpoints = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false, defaultValue: "{}"),
                    ArchivedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    ArchivedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System"),
                    ArchiveReason = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false, defaultValue: "Cleanup"),
                    OriginalCreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    OriginalLastModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    OriginalCreatedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    OriginalLastModifiedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchivedJobs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeverityLevel = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 3),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    CategoryGroup = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "General"),
                    ApplicableProcesses = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    StandardCorrectiveActions = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    PreventionMethods = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    RequiresImmediateNotification = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    CostImpact = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false, defaultValue: "Medium"),
                    AverageResolutionTimeMinutes = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 30),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 100),
                    ColorCode = table.Column<string>(type: "TEXT", maxLength: 7, nullable: false, defaultValue: "#6B7280"),
                    Icon = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "exclamation-triangle"),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    LastModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    CreatedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System"),
                    LastModifiedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Environment = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false, defaultValue: "All"),
                    RequiredRole = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "User"),
                    RolloutPercentage = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 100),
                    StartDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    EndDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    RequiresRestart = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    Dependencies = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    Conflicts = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    Configuration = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false, defaultValue: "{}"),
                    ...
                    PerformanceNotes = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    SecurityNotes = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    IntroducedInVersion = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    PlannedRemovalVersion = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false, defaultValue: "Experimental"),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 100),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    LastModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    CreatedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHoliday = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasPermission = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    PermissionLevel = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false, defaultValue: "Read"),
                    Category = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "General"),
                    Description = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    Priority = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 100),
                    Constraints = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false, defaultValue: "{}"),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    LastModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    CreatedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System"),
                    LastModifiedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SettingValue = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    DataType = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false, defaultValue: "String"),
                    Category = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "General"),
                    Description = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ...
                    RequiresRestart = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    ValidationRules = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "InspectionCheckpoints",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PartId = table.Column<int>(type: "INTEGER", nullable: false),
                    CheckpointName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    InspectionType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "Visual"),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 100),
                    IsRequired = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    EstimatedMinutes = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 5),
                    AcceptanceCriteria = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    MeasurementMethod = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    RequiredEquipment = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    RequiredSkills = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ReferenceDocuments = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    TargetValue = table.Column<double>(type: "REAL", nullable: true),
                    UpperTolerance = table.Column<double>(type: "REAL", nullable: true),
                    LowerTolerance = table.Column<double>(type: "REAL", nullable: true),
                    Unit = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    FailureAction = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false, defaultValue: "Hold for review"),
                    SampleSize = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 1),
                    SamplingMethod = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "All"),
                    Category = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "Quality"),
                    Priority = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 3),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    LastModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    CreatedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System"),
                    LastModifiedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System"),
                    DefectCategoryId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InspectionCheckpoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InspectionCheckpoints_DefectCategories_DefectCategoryId",
                        column: x => x.DefectCategoryId,
                        principalTable: "DefectCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InspectionCheckpoints_Parts_PartId",
                        column: x => x.PartId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapabilityType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    CapabilityName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CapabilityValue = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ...
                    Unit = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    RequiredCertification = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    LastModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    CreatedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System"),
                    LastModifiedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "System")
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminAlerts_AlertName",
                table: "AdminAlerts",
                column: "AlertName");

            migrationBuilder.CreateIndex(
                name: "IX_AdminAlerts_Category",
                table: "AdminAlerts",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_AdminAlerts_IsActive",
                table: "AdminAlerts",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AdminAlerts_LastTriggered",
                table: "AdminAlerts",
                column: "LastTriggered");

            migrationBuilder.CreateIndex(
                name: "IX_AdminAlerts_SeverityLevel",
                table: "AdminAlerts",
                column: "SeverityLevel");

            migrationBuilder.CreateIndex(
                name: "IX_AdminAlerts_TriggerType",
                table: "AdminAlerts",
                column: "TriggerType");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedJobs_ArchivedBy",
                table: "ArchivedJobs",
                column: "ArchivedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedJobs_ArchivedDate",
                table: "ArchivedJobs",
                column: "ArchivedDate");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedJobs_MachineId",
                table: "ArchivedJobs",
                column: "MachineId");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedJobs_MachineId_ScheduledStart",
                table: "ArchivedJobs",
                columns: new[] { "MachineId", "ScheduledStart" });

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedJobs_OriginalJobId",
                table: "ArchivedJobs",
                column: "OriginalJobId");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedJobs_PartNumber",
                table: "ArchivedJobs",
                column: "PartNumber");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedJobs_Status",
                table: "ArchivedJobs",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DefectCategories_CategoryGroup",
                table: "DefectCategories",
                column: "CategoryGroup");

            migrationBuilder.CreateIndex(
                name: "IX_DefectCategories_Code",
                table: "DefectCategories",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_DefectCategories_IsActive",
                table: "DefectCategories",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_DefectCategories_Name",
                table: "DefectCategories",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_DefectCategories_SeverityLevel",
                table: "DefectCategories",
                column: "SeverityLevel");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatureToggles_Environment",
                table: "FeatureToggles",
                column: "Environment");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatureToggles_RequiredRole",
                table: "FeatureToggles",
                column: "RequiredRole");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InspectionCheckpoints_DefectCategoryId",
                table: "InspectionCheckpoints",
                column: "DefectCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_InspectionCheckpoints_InspectionType",
                table: "InspectionCheckpoints",
                column: "InspectionType");

            migrationBuilder.CreateIndex(
                name: "IX_InspectionCheckpoints_IsActive",
                table: "InspectionCheckpoints",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_InspectionCheckpoints_IsRequired",
                table: "InspectionCheckpoints",
                column: "IsRequired");

            migrationBuilder.CreateIndex(
                name: "IX_InspectionCheckpoints_PartId",
                table: "InspectionCheckpoints",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_InspectionCheckpoints_PartId_SortOrder",
                table: "InspectionCheckpoints",
                columns: new[] { "PartId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_MachineCapabilities_CapabilityType",
                table: "MachineCapabilities",
                column: "CapabilityType");

            migrationBuilder.CreateIndex(
                name: "IX_MachineCapabilities_IsAvailable",
                table: "MachineCapabilities",
                column: "IsAvailable");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "MachineCapabilities",
                columns: new[] { "SlsMachineId", "CapabilityType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperatingShifts_DayOfWeek",
                table: "OperatingShifts",
                column: "DayOfWeek");

            migrationBuilder.CreateIndex(
                name: "IX_OperatingShifts_DayOfWeek_IsActive",
                table: "OperatingShifts",
                columns: new[] { "DayOfWeek", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_OperatingShifts_IsActive",
                table: "OperatingShifts",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_OperatingShifts_IsHoliday",
                table: "OperatingShifts",
                column: "IsHoliday");

            migrationBuilder.CreateIndex(
                name: "IX_OperatingShifts_SpecificDate",
                table: "OperatingShifts",
                column: "SpecificDate");

            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_Category",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemSettings_Category_DisplayOrder",
                table: "SystemSettings",
