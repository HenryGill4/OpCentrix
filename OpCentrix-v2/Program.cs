...
using OpCentrix.Services.Auth;
using OpCentrix.Services.Platform;
...
// ?? Ensure platform DB is created + seed default admin ?????????
using (var scope = app.Services.CreateScope())
{
    ...
    await authService.EnsureDefaultSuperAdminAsync();
}
